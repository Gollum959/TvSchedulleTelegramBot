...
from ScheduleDocument import ScheduleDocument


this_week_local_file_name = "\\Test Right Directory\\thisweek.docx"
next_week_local_file_name = "\\Test Right Directory\\nextweek.docx"

doc_this_week = ScheduleDocument(this_week_local_file_name)
doc_this_week.init()
list_pts_and_hardware_this_week = doc_this_week.get_map()

doc_next_week = ScheduleDocument(next_week_local_file_name)
doc_next_week.init()
